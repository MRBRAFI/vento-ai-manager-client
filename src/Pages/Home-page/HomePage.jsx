...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-base-100 text-base-content selection:bg-primary/20">
      ...
      <section className="relative pt-28 pb-16 md:pt-40 md:pb-28 overflow-hidden">
        ...
        <div className="w-11/12 max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            >
              <div
                className="inline-flex items-center gap-2 px-4 py-2 mb-8 text-xs font-bold tracking-widest uppercase rounded-full bg-base-200/50 border border-base-300 backdrop-blur-sm"
              >
              ...
              <p className="text-lg md:text-xl text-gray-500 mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                The enterprise-grade platform to organize, track, and deploy your neural assets. Vento brings clarity to your AI chaos.
              </p>

              <div className="flex flex-wrap justify-center lg:justify-start gap-4 mb-12">
                <Link to="/register" className="shimmer-btn px-8 py-4 bg-primary text-white font-bold rounded-2xl shadow-xl shadow-primary/20 hover:-translate-y-1 transition-all">
                  Get Started Free
                </Link>
                <Link to="/all_models" className="px-8 py-4 glass-effect font-bold rounded-2xl hover:bg-base-200 transition-all hover:-translate-y-1 border border-white/10 shadow-lg">
                  Explore Marketplace
                </Link>
              </div>
              ...
              <div className="flex justify-center lg:justify-start gap-8 md:gap-16 pt-8 border-t border-base-200 dark:border-white/5">
                {[
                  ...
                  <div key={i} className="text-center lg:text-left">
                    <p className="text-2xl md:text-3xl font-black mb-1">{stat.val}</p>
                    <p className="text-xs uppercase font-bold tracking-widest opacity-40">{stat.label}</p>
                  </div>
                ))}
              </div>
            </motion.div>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="w-11/12 max-w-7xl mx-auto mb-10 flex flex-col md:flex-row items-end justify-between gap-6">
             <div className="max-w-xl">
                 <h2 className="text-3xl md:text-4xl font-black mb-4">See Vento in <span className="text-primary italic">Action</span></h2>
                 <p className="text-gray-500">Explore how top teams are utilizing our platform for their ML pipelines.</p>
             </div>
        </div>
        <HeroSlider />
      </section>
      ...
      <div className="py-10 relative bg-base-300/30 rounded-[3rem] mx-2 md:mx-4 my-10 border border-white/5">
