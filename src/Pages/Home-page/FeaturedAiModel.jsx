...
const FeaturedAiModel = ({ data }) => {
  ...
  return (
    <section className="py-20 mx-auto max-w-7xl">
      <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6 mx-10">
        <div className="max-w-2xl">
          ...
          >
            Discover the most powerful and efficient models in our inventory.
            Hand-picked for performance and accuracy.
          </motion.p>
        </div>
        <Link
          to="/all_models"
